            ...
            <section className='maincontainer'>
                ...
                <div className='container2'>
                    ...
                    <FormGroup aria-label="position" row>
                        ...
                        value="admin"
                        control={<Checkbox />}
                        label={<span style={{fontSize: '1rem', color: "#8C91AA"}}>Admin</span>}
                        ...
                        value="supervisor"
                        control={<Checkbox />}
                        label={<span style={{fontSize: '1rem', color: "#8C91AA"}}>Supervisor</span>}
                        labelPlacement="bottom"
                        ...
                        value="student"
                        control={<Checkbox />}
                        label={<span style={{fontSize: '1rem', color: "#8C91AA"}}>Student</span>}
                        labelPlacement="bottom"
                        sx={{ '& .MuiSvgIcon-root': { fontSize: 24 }, marginLeft: '-0.3rem' }}
                        onChange={Student}
                        checked={forStudent}
                        ...
                        value="manager"
                        control={<Checkbox />}
                        label={<span style={{fontSize: '1rem', color: "#8C91AA", paddingTop: '4rem'}}>Manager</span>}
                        labelPlacement="bottom"
                    ...
                    <form>
                        <fieldset>
                            ...
                            value="showpassword"
                            control={<Checkbox />}
                            label={<span style={{fontSize: '0.875rem', color: "#8C91AA", marginLeft: '-0.5rem' }}>Show Password</span>}
